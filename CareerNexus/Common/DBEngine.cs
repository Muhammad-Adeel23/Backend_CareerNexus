...
namespace CareerNexus.Common
{
    public static class DBEngine 
    {
      ...
      ?? "workstation id=CareerNexus.mssql.somee.com;packet size=4096;user id=CareerNexus;pwd=careernexus;data source=CareerNexus.mssql.somee.com;persist security info=False;initial catalog=CareerNexus;TrustServerCertificate=True";  
